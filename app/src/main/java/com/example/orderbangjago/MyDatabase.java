...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    private static final String tb_mhsiswa_jumlah = "jumlah";
    ...
    public void CreateMahasiswa (Mahasiswa mdNotif) {
        ...
        values.put(tb_mhsiswa_jumlah, mdNotif.get_jumlah());
    ...
    public List<Mahasiswa> ReadMahasiswa() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                mdKontak.set_jumlah(cursor.getString(3));
